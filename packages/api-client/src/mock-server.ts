...
// The deep forensic trace lives OUT of `mockRun` so the list/latest fixtures stay
// lean (trace-less), mirroring prod where only the detail endpoint hydrates it.
// Shaped to `RunTrace`: exercises a failed fetcher, a populated crawl, dedupe/mute
// drops, and a spread of candidate journeys so the run-detail page has real data.
const mockRunTrace = {
  queries: ["rust async runtime", "self-hosting homelab 2026", "tailscale mesh vpn"],
  profileTerms: [
    { term: "rust", weight: 0.61 },
    { term: "homelab", weight: 0.44 },
    { term: "self-hosting", weight: 0.38 },
    { term: "kubernetes", weight: 0.22 },
    { term: "tailscale", weight: 0.17 },
  ],
  fetchers: [
    {
      name: "searxng",
      ...
      durationMs: 812,
      results: [
        { url: "https://example.org/rust-async", title: "Understanding Rust async" },
        { url: "https://example.org/homelab-2026", title: "My 2026 homelab" },
        { url: "https://blog.example.com/tailscale", title: "Tailscale mesh basics" },
      ],
    },
    {
      name: "brave",
      enabled: true,
      ok: false,
      error: "brave: 401 Unauthorized (no API key configured)",
      count: 0,
      durationMs: 143,
      results: [] as Array<{ url: string; title: string | null }>,
    },
    {
      name: "crawl",
      enabled: true,
      ...
      durationMs: 4210,
      results: [
        { url: "https://blog.example.com/k8s-at-home", title: "Kubernetes at home" },
        { url: "https://notes.example.net/zfs", title: "ZFS for the paranoid" },
      ],
    },
  ],
  crawl: {
    seeds: ["https://blog.example.com/", "https://notes.example.net/"],
    stopReason: "deadline" as "drained" | "deadline" | "limit",
    depthReached: 2,
    pagesFetched: 18,
    pagesSkipped: 3,
    linksEnqueued: 47,
    ...
    hosts: [
      {
        ...
        visited: 11,
        robots: "allow-all" as "allow-all" | "restricted" | "unreachable",
        robotsBlocked: 0,
        capHit: false,
      },
      {
        ...
        visited: 7,
        robots: "restricted" as "allow-all" | "restricted" | "unreachable",
        robotsBlocked: 4,
        capHit: true,
      },
      {
        host: "shop.example.io",
        visited: 0,
        robots: "unreachable" as "allow-all" | "restricted" | "unreachable",
        robotsBlocked: 0,
        capHit: false,
      },
    ],
    rejections: [
      { url: "https://blog.example.com/about", reason: "non-content" as const },
      { url: "https://notes.example.net/private/notes", reason: "robots" as const },
      { url: "https://blog.example.com/tag/rust", reason: "non-content" as const },
      { url: "https://notes.example.net/broken", reason: "http-error" as const },
      { url: "https://notes.example.net/deep/page", reason: "host-cap" as const },
    ],
  },
  dedupeDropped: 12,
  mutedDropped: ["pinterest.com", "medium.com"],
  candidates: [
    {
      url: "https://example.org/rust-async",
      ...
      rank: 1,
      selected: true,
      extracted: "ok" as "ok" | "failed" | "skipped",
      snippetCosine: 0.31,
      fullTextCosine: 0.42,
      matchedTerms: ["rust", "async", "runtime"],
    },
    {
      url: "https://blog.example.com/k8s-at-home",
      ...
      snippetCosine: 0.27,
      fullTextCosine: 0.39,
      matchedTerms: ["kubernetes", "homelab", "self-hosting"],
    },
    {
      url: "https://example.org/homelab-2026",
      title: "My 2026 homelab",
      fetcher: "searxng",
      cosine: 0.36,
      recency: 0.87,
      finalScore: 0.3132,
      ...
      snippetCosine: 0.29,
      fullTextCosine: 0.36,
      matchedTerms: ["homelab", "self-hosting"],
    },
    {
      url: "https://notes.example.net/zfs",
      title: "ZFS for the paranoid",
      fetcher: "crawl",
      cosine: 0.28,
      recency: 0.72,
      finalScore: 0.2016,
      rank: 4,
      selected: false,
      extracted: "failed" as "ok" | "failed" | "skipped",
      snippetCosine: 0.28,
      fullTextCosine: null as number | null,
      matchedTerms: [] as string[],
    },
    {
      url: "https://blog.example.com/tailscale",
      title: "Tailscale mesh basics",
      fetcher: "searxng",
      cosine: 0.24,
      recency: 0.95,
      finalScore: 0.228,
      ...
      snippetCosine: 0.21,
      fullTextCosine: 0.24,
      matchedTerms: ["tailscale", "vpn"],
    },
    {
      url: "https://example.org/rust-embedded",
      ...
      rank: 6,
      selected: false,
      extracted: "skipped" as "ok" | "failed" | "skipped",
      snippetCosine: 0.19,
      fullTextCosine: null as number | null,
      matchedTerms: [] as string[],
    },
    ...
    {
      url: "https://misc.example.com/unrelated",
      title: "Something off-topic",
      fetcher: "searxng",
      cosine: 0.08,
      recency: 0.99,
      finalScore: 0.0792,
...
const handlers: Record<string, MockHandler> = {
  ...
  // The one endpoint that ships the deep forensic trace. Match on the mock run's
  // id but fall back to it so any :id renders data in dev.
  getDiscoveryRun: ({ params }) => ({
    json: { run: { ...mockRun, id: params.id || mockRun.id, trace: mockRunTrace } },
  }),
  getDiscoveryConfig: () => ({

...
<style>
	...
	/* Mobile: the absolute dropdown can fall below the fold, forcing a scroll to
	   reach it. Promote it to a viewport-anchored bottom sheet so every item is
	   reachable. Matches the reader's Display-panel pattern. */
